...
def train_reward_model(
    ...
    # Initialize reasoning generator for data generation
    ...
    training_args = TrainingArguments(
        ...
        learning_rate=train_config['reward_training']['learning_rate'],
...
def train_policy(
    ...
    """
    Train the policy network with PPO.

    Args:
        model_config: Model configuration
        train_config: Training configuration
        gsm8k_train_data: Training data
        gsm8k_val_data: Validation data
    ...
    reward_model = ProcessRewardModel.from_pretrained(reward_model_path)
...
def main():
    ...
    parser = argparse.ArgumentParser(description='Train PGTS for GSM8k')
    parser.add_argument('--model_config', type=str, default='config/model_config.yaml',
                       help='Path to model config')
    parser.add_argument('--train_config', type=str, default='config/training_config.yaml',
